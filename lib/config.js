...
console.log("Checking job...");  
  ...
  if(job.cycle_operations && (typeof job.cycle_operations !== 'boolean')) {
    console.log('Error: Illegal value specified for cycle_operations.');
    process.exit();
  }
